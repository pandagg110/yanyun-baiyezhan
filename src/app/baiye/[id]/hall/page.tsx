                        ...
                        <PixelCard className="space-y-4 bg-neutral-800">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        onClick={() => setRoomType("healer")}
                                        className={`flex-1 py-2 text-sm font-bold border-2 transition-colors ${roomType === 'healer' ? 'bg-yellow-500 text-black border-yellow-600' : 'bg-neutral-700 text-white border-neutral-600 hover:border-neutral-500'}`}
                                    >
                                        霖霖大王
                                    </button>
                                </div>
